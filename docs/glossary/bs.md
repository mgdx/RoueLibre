...
| Face north | **Okreni prema sjeveru** | `map_face_north`, on the compass, which shows only while the map is turned; `map_bearing_description` counts the turn in *stepeni*, over the three categories. |
