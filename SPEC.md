...
- **The switch is remembered, and it is the only thing this screen keeps** (§8). What somebody rides is a fact about them where the two points are a fact about one trip, and asking again at every journey would ask them the same answer every time. What is written is a yes or a no about equipment: no point, no time, no destination goes with it (§2, C3).
