...
- **A journey on one's own bike (§7.3) has one row**, "ride to the destination", with its distance and its climb, and no station row between anything. The note saying the counts are frozen goes with them — it has nothing left to qualify — and the bike drawn beside the row is the plain one, whatever the network lends: the bolt and the cog describe what waits at a station (§15). The ground the ride runs over is drawn as below, the whole journey being the ride.
