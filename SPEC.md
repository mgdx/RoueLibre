...
That screen leads straight into the download confirmation described in §4.4, with the size announced — **a single sequence, not two successive walls of text**. Four screens at most, each skippable, and a button to postpone the download. It was three until the fleet page was added on 14 August 2026; a fourth is the ceiling, and anything else to say belongs in "about" rather than in front of somebody who has not yet seen a map.
