...
- List of steps, one line per leg, **folded behind a "details" button** and opened by it. The time, the summary and the drawing answer the question; the three lines that name the stations are what one asks for next, and folded away they give the map the height they were taking. The button says what the press will do, and disappears when there is no step to open. It comes **last of the reading, just above the recompute button**, and the steps open under it: everything the screen offers to do comes after everything it has to say.
