...
- **A journey on one's own bike (§7.3) is read the same way, in one leg.** The total time is the ride's, the summary under it says how far it runs and what it climbs — "16 min · on your own bike, over 5.2 km and 15 m of climb" — and the drawing is one unbroken stroke between the two ends, in the shape the search screen showed. Nothing is said of bikes or of docks, there being no station to count them at, and nothing is said of the walking either. The wait says it is working the ride out rather than looking for the best journey: there is one route to trace, not a pair of stations to weigh. The switch is not repeated here — a point corrected on this screen corrects the question, where changing bike asks another one, and this screen is not where one is asked.
